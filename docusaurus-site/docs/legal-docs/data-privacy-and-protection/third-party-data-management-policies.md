...
Once the third party decrypts and accesses the corresponding data, it can decide whether to keep it stored internally or not, especially considering the existence of any grants given with an associated timelock. Once the dApp downloads the data, its usage is outside of the idOS' control. 
