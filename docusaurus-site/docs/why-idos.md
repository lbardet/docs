...
Self-custody of data puts users in control of what is stored and who has access to their data. In the internet, users' data for almost all applications is currently centrally held, siloed and retracted from any oversight. Duplicating sensitive user data to store them in central honeypots where they rot away is a big liability and it's bad for business and users alike. 
...
![idOS as a decentralized identity settlement layer](/assets/image-13.png)
