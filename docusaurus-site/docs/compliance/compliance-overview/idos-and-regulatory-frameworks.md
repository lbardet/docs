...
Through [Access Grants](/how-it-works/system-architecture/on-chain-access-grants), the duration of Credential access can be set through "Time Locks." This ensures Data Consumers can remain compliant with applicable retention periods resulting from e.g. AML regulations.
