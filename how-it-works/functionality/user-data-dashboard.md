...
* Directing users to [data verification providers](../system-architecture/roles-main-stakeholders.md#identity-verification-providers) to receive verified credentials
